...
function oneLetterRelationCode(relation){
  var letterIndex=acg_ArchiMateRelations.indexOf(relation.data("edgeType"));
...
function allowedArchiMateRelation(edge){
  ...
  if (letter === undefined || sourceIndex ===  undefined || targetIndex === undefined){
    console.log(sourceType+ " "+edge.data("edgeType")+ " "+ " "+targetType + " undefined");
      ;
    return undefined} 
    else{
     // console.log(sourceType+ " "+edge.data("edgeType")+ " "+ ArchiMateRelations[sourceIndex][targetIndex+1]+ " "+targetType);
