  ...
  en: {
    translation: {
      menu: {
        ...
        filesave: "Save",
        fileimport: "Import",
        fileimportjarchicg: "jArchiCG",
        fileimportoef: "OEF",
        fileimportjson: "JSON",
        fileexport: "Export",
        fileexportcsv: "CSV",
        fileexportowl: "OWL",
        filesaveasimage: "Image",
        filesaveasimageviewpng: "View PNG",
        filesaveasimagefullpng: "Full PNG",
        filesaveasimageviewjpg: "View JPG",
        filesaveasimagefulljpg: "FullJPG",
        filesaveasimageviewsvg: "View SVG",
        filesaveasimagefullsvg: "Full SVG",
        compoundgraph: "Compound Graph",
        compoundgraphnodes: "Nodes",
        compoundgraphcollapseallnodes: "Collapse all",
        compoundgraphcollapseselectedrecursively: "Collapse selected",
        compoundgraphcexpandallnodes: "Expand All",
        compoundgraphexpandselectedrecursively: "Expand Selected Recursively",
        compoundgraphaddcompoundforselected: "Add Compound For Selected",
        compoundgraphremoveselectedcompound: "Remove Selected Compound",
        compoundgraphaddnestedforselected: "Add Nested For Selected",
        compoundgraphcreatenodes: "Create Nodes",
        compoundgraphedges: "Edges",
        compoundgraphedgescollapsealledges: "Collapse All Edges",
        compoundgraphedgesexpandalledges: "Expand All Edges",
        compoundgraphedgescollapseselectededges: "Collapse Selected Edges",
        compoundgraphedgesexpandselectededges: "Expand Selected Edges",
        compoundgraphedgescollapsebetweenselected: "Collapse Between Selected",
        compoundgraphedgesexpandbetweenselected: "Expand Between Selected",
        compositegraph: "Composite Graph",
        compositegraphselectedcompoundtograph: "Selected Compound to Graph",
        compositegraphselectedgraphtocompound: "Selected Graph To Compound",
        compositegraphcreatecomponent: "Create Component",
        compositegraphshowedges: "Show Edges",
        compositegraphhideedges: "Hide Edges",
        graphmanipulation: "Graph Manipulation",
        graphmanipulationshowhide: "Show/Hide",
        graphmanipulationhideselected: "Hide Selected",
        graphmanipulationhidenonselected: "Hide Non Selected",
        graphmanipulationunhideall: "Unhide All",
        graphmanipulationgrabiphyungrabify: "Grabiphy/Ungrabiphy",
        graphmanipulationungrabifyselected: "Ungrabify Selected",
        graphmanipulationungrabifynonselected: "Ungrabify Non Selected",
        graphmanipulationgrabifyselected: "Grabify Selected",
        graphmanipulationgrabifynonselected: "Grabify Non Selected",
        graphmanipulationlockunlock: "Lock/Unlock",
        graphmanipulationgrabifylockselected: "Lock Selected",
        graphmanipulationgrabifylocknonselected: "Lock Non Selected",
        graphmanipulationgrabifyunlockselected: "Unlock Selected",
        graphmanipulationgrabifyunlocknonselected: "Unlock Non Selected",
        graphmanipulationremoverestore: "Remove/Restore",
        graphmanipulationremoveselected: "Remove Selected",
        graphmanipulationremoveunselected: "Remove Unselected",
        graphmanipulationremoveall: "Remove All",
        graphmanipulationrestore: "Restore",
        parameters: "Parameters",
        tooltips: "Tooltips",
        tooltipson: "Tooltips On",
        tooltipsoff: "Tooltips Off",
        log: "Log",
        showhidelog: "Hide Log",
        visualelementdisplaymode: "Visual Element Display Mode",
        visualelementdisplaymodenodes: "Display Mode Node",
        visualelementdisplaymodeboxes: "Display Mode Box",
        visualrelationdisplaymode: "Visual Relation Display Mode",
        visualrelationdisplaymodeedges: "Display Mode Edge",
        visualrelationdisplaymodenodes: "Display Mode Node",
        undoredo: "Undo/Redo",
        undoredoon: "On",
        undoredooff: "Off",
        undoredoclear: "Clear",
        archimaterelationshipsrules: "ArchiMate Relationships Rules",
        archimaterelationshiprulesenforce: "Enforce",
        archimaterelationshiprulesrelax: "Relax",
        urlnavigation: "URL Navigation",
        urlnavigationchangemode: "Change Mode",
        checker: "Checker",
        allowedrelationship: "ArchiMate Allowed Relationship",
        palettes: "Palettes",
        archicg: "ArchiCG",
  ...
  fr: {
    translation: {
      menu: {
        ...
        fileexportowl: "OWL",
        filesaveasimage: "Image",
        filesaveasimageviewpng: "Vue PNG",
        filesaveasimagefullpng: "PNG Complet",
        filesaveasimageviewjpg: "Vue JPG",
        filesaveasimagefulljpg: "JPG Complet",
        filesaveasimageviewsvg: "Vue SVG",
        filesaveasimagefullsvg: "SVG Complet",
        compoundgraph: "Graphe Composé",
        compoundgraphnodes: "Nœuds",
        compoundgraphcollapseallnodes: "Tout Réduire",
        compoundgraphcollapseselectedrecursively: "Réduire la Sélection",
        compoundgraphcexpandallnodes: "Tout Développer",
        compoundgraphexpandselectedrecursively: "Développer la Sélection",
        compoundgraphaddcompoundforselected: "Ajouter un Composé à la Sélection",
        compoundgraphremoveselectedcompound: "Supprimer le Composé Sélectionné",
        compoundgraphaddnestedforselected: "Ajouter un Emboîté à la Sélection",
        compoundgraphcreatenodes: "Créer des Nœuds",
        compoundgraphedges: "Arêtes",
        compoundgraphedgescollapsealledges: "Réduire Toutes les Arêtes",
        compoundgraphedgesexpandalledges: "Développer Toutes les Arêtes",
        compoundgraphedgescollapseselectededges: "Réduire les Arêtes Sélectionnées",
        compoundgraphedgesexpandselectededges: "Développer les Arêtes Sélectionnées",
        compoundgraphedgescollapsebetweenselected: "Réduire Entre la Sélection",
        compoundgraphedgesexpandbetweenselected: "Développer Entre la Sélection",
        compositegraph: "Graphe Composite",
        compositegraphselectedcompoundtograph: "Composé Sélectionné vers Graphe",
        compositegraphselectedgraphtocompound: "Graphe Sélectionné vers Composé",
        compositegraphcreatecomponent: "Créer un Composant",
        compositegraphshowedges: "Afficher les Arêtes",
        compositegraphhideedges: "Masquer les Arêtes",
        graphmanipulation: "Manipulation du Graphe",
        graphmanipulationshowhide: "Afficher/Masquer",
        graphmanipulationhideselected: "Masquer la Sélection",
        graphmanipulationhidenonselected: "Masquer Non Sélectionnés",
        graphmanipulationunhideall: "Tout Réafficher",
        graphmanipulationgrabiphyungrabify: "Grabifier/Ungrabifier",
        graphmanipulationungrabifyselected: "Ungrabifier la Sélection",
        graphmanipulationungrabifynonselected: "Ungrabifier Non Sélectionnés",
        graphmanipulationgrabifyselected: "Grabifier la Sélection",
        graphmanipulationgrabifynonselected: "Grabifier Non Sélectionnés",
        graphmanipulationlockunlock: "Verrouiller/Déverrouiller",
        graphmanipulationgrabifylockselected: "Verrouiller la Sélection",
        graphmanipulationgrabifylocknonselected: "Verrouiller Non Sélectionnés",
        graphmanipulationgrabifyunlockselected: "Déverrouiller la Sélection",
        graphmanipulationgrabifyunlocknonselected: "Déverrouiller Non Sélectionnés",
        graphmanipulationremoverestore: "Supprimer/Restaurer",
        graphmanipulationremoveselected: "Supprimer la Sélection",
        graphmanipulationremoveunselected: "Supprimer Non Sélectionnés",
        graphmanipulationremoveall: "Tout Supprimer",
        graphmanipulationrestore: "Restaurer",
        parameters: "Paramètres",
        tooltips: "Infobulles",
        tooltipson: "Infobulles Activées",
        tooltipsoff: "Infobulles Désactivées",
        log: "Journal",
        showhidelog: "Masquer le Journal",
        visualelementdisplaymode: "Mode d’Affichage des Éléments Visuels",
        visualelementdisplaymodenodes: "Mode d’Affichage des Nœuds",
        visualelementdisplaymodeboxes: "Mode d’Affichage Boîte",
        visualrelationdisplaymode: "Mode d’Affichage des Relations Visuelles",
        visualrelationdisplaymodeedges: "Mode d’Affichage des Arêtes",
        visualrelationdisplaymodenodes: "Mode d’Affichage des Nœuds",
        undoredo: "Annuler/Rétablir",
        undoredoon: "Activé",
        undoredooff: "Désactivé",
        undoredoclear: "Réinitialiser",
        archimaterelationshipsrules: "Règles de Relations ArchiMate",
        archimaterelationshiprulesenforce: "Appliquer",
        archimaterelationshiprulesrelax: "Assouplir",
        urlnavigation: "Navigation par URL",
        urlnavigationchangemode: "Changer de Mode",
        checker: "Vérificateur",
        allowedrelationship: "Relations ArchiMate Autorisées",
        palettes: "Palettes",
        archicg: "ArchiCG",
  ...
  de: {
    translation: {
      menu: {
        ...
        fileexportcsv: "CSV",
        fileexportowl: "OWL",
        filesaveasimage: "Bild",
        filesaveasimageviewpng: "Ansicht PNG",
        filesaveasimagefullpng: "Vollständiges PNG",
        filesaveasimageviewjpg: "Ansicht JPG",
        filesaveasimagefulljpg: "Vollständiges JPG",
        filesaveasimageviewsvg: "Ansicht SVG",
        filesaveasimagefullsvg: "Vollständiges SVG",
        compoundgraph: "Strukturierter Graph",
        compoundgraphnodes: "Knoten",
        compoundgraphcollapseallnodes: "Alle Einklappen",
        compoundgraphcollapseselectedrecursively: "Auswahl Einklappen",
        compoundgraphcexpandallnodes: "Alle Ausklappen",
        compoundgraphexpandselectedrecursively: "Auswahl Ausklappen",
        compoundgraphaddcompoundforselected: "Zusammengesetzten Knoten zur Auswahl hinzufügen",
        compoundgraphremoveselectedcompound: "Ausgewählten Zusammengesetzten Knoten entfernen",
        compoundgraphaddnestedforselected: "Verschachtelten Knoten zur Auswahl hinzufügen",
        compoundgraphcreatenodes: "Knoten erstellen",
        compoundgraphedges: "Kanten",
        compoundgraphedgescollapsealledges: "Alle Kanten einklappen",
        compoundgraphedgesexpandalledges: "Alle Kanten ausklappen",
        compoundgraphedgescollapseselectededges: "Ausgewählte Kanten einklappen",
        compoundgraphedgesexpandselectededges: "Ausgewählte Kanten ausklappen",
        compoundgraphedgescollapsebetweenselected: "Zwischen Auswahl einklappen",
        compoundgraphedgesexpandbetweenselected: "Zwischen Auswahl ausklappen",
        compositegraph: "Kompositgraph",
        compositegraphselectedcompoundtograph: "Ausgew. Komposit zu Graph",
        compositegraphselectedgraphtocompound: "Ausgew. Graph zu Komposit",
        compositegraphcreatecomponent: "Komponente erstellen",
        compositegraphshowedges: "Kanten anzeigen",
        compositegraphhideedges: "Kanten ausblenden",
        graphmanipulation: "Graphmanipulation",
        graphmanipulationshowhide: "Anzeigen/Ausblenden",
        graphmanipulationhideselected: "Auswahl ausblenden",
        graphmanipulationhidenonselected: "Nicht ausgewählte ausblenden",
        graphmanipulationunhideall: "Alle einblenden",
        graphmanipulationgrabiphyungrabify: "Grabify/Ungrabify",
        graphmanipulationungrabifyselected: "Auswahl ungrabify",
        graphmanipulationungrabifynonselected: "Nicht ausgewählte ungrabify",
        graphmanipulationgrabifyselected: "Auswahl grabify",
        graphmanipulationgrabifynonselected: "Nicht ausgewählte grabify",
        graphmanipulationlockunlock: "Sperren/Entsperren",
        graphmanipulationgrabifylockselected: "Auswahl sperren",
        graphmanipulationgrabifylocknonselected: "Nicht ausgewählte sperren",
        graphmanipulationgrabifyunlockselected: "Auswahl entsperren",
        graphmanipulationgrabifyunlocknonselected: "Nicht ausgewählte entsperren",
        graphmanipulationremoverestore: "Entfernen/Wiederherstellen",
        graphmanipulationremoveselected: "Auswahl entfernen",
        graphmanipulationremoveunselected: "Nicht ausgewählte entfernen",
        graphmanipulationremoveall: "Alle entfernen",
        graphmanipulationrestore: "Wiederherstellen",
        parameters: "Parameter",
        tooltips: "Tooltips",
        tooltipson: "Tooltips an",
        tooltipsoff: "Tooltips aus",
        log: "Protokoll",
        showhidelog: "Protokoll ein-/ausblenden",
        visualelementdisplaymode: "Anzeige-Modus für visuelle Elemente",
        visualelementdisplaymodenodes: "Knoten-Anzeigemodus",
        visualelementdisplaymodeboxes: "Box-Anzeigemodus",
        visualrelationdisplaymode: "Anzeige-Modus für visuelle Relationen",
        visualrelationdisplaymodeedges: "Kanten-Anzeigemodus",
        visualrelationdisplaymodenodes: "Knoten-Anzeigemodus",
        undoredo: "Rückgängig/Wiederholen",
        undoredoon: "An",
        undoredooff: "Aus",
        undoredoclear: "Zurücksetzen",
        archimaterelationshipsrules: "ArchiMate-Beziehungsregeln",
        archimaterelationshiprulesenforce: "Erzwingen",
        archimaterelationshiprulesrelax: "Lockern",
        urlnavigation: "URL-Navigation",
        urlnavigationchangemode: "Modus wechseln",
        checker: "Prüfer",
        allowedrelationship: "Erlaubte ArchiMate-Beziehungen",
        palettes: "Paletten",
        archicg: "ArchiCG",
  ...
  ar: {
    translation: {
      menu: {
        ...
        fileexportcsv: "CSV",
        fileexportowl: "OWL",
        filesaveasimage: "صورة",
        filesaveasimageviewpng: "عرض PNG",
        filesaveasimagefullpng: "PNG كاملة",
        filesaveasimageviewjpg: "عرض JPG",
        filesaveasimagefulljpg: "JPG كاملة",
        filesaveasimageviewsvg: "عرض SVG",
        filesaveasimagefullsvg: "SVG كاملة",
        compoundgraph: "رسم بياني مركب",
        compoundgraphnodes: "العُقَد",
        compoundgraphcollapseallnodes: "طيّ الكل",
        compoundgraphcollapseselectedrecursively: "طيّ المحدد",
        compoundgraphcexpandallnodes: "توسيع الكل",
        compoundgraphexpandselectedrecursively: "توسيع المحدد",
        compoundgraphaddcompoundforselected: "إضافة مركب للمحدد",
        compoundgraphremoveselectedcompound: "إزالة المركب المحدد",
        compoundgraphaddnestedforselected: "إضافة متداخل للمحدد",
        compoundgraphcreatenodes: "إنشاء عُقَد",
        compoundgraphedges: "الحواف",
        compoundgraphedgescollapsealledges: "طيّ جميع الحواف",
        compoundgraphedgesexpandalledges: "توسيع جميع الحواف",
        compoundgraphedgescollapseselectededges: "طيّ الحواف المحددة",
        compoundgraphedgesexpandselectededges: "توسيع الحواف المحددة",
        compoundgraphedgescollapsebetweenselected: "طيّ بين المحدد",
        compoundgraphedgesexpandbetweenselected: "توسيع بين المحدد",
        compositegraph: "رسم بياني مركب",
        compositegraphselectedcompoundtograph: "تحويل المركب المحدد إلى رسم",
        compositegraphselectedgraphtocompound: "تحويل الرسم المحدد إلى مركب",
        compositegraphcreatecomponent: "إنشاء مكوّن",
        compositegraphshowedges: "إظهار الحواف",
        compositegraphhideedges: "إخفاء الحواف",
        graphmanipulation: "تحكم بالرسم",
        graphmanipulationshowhide: "إظهار / إخفاء",
        graphmanipulationhideselected: "إخفاء المحدد",
        graphmanipulationhidenonselected: "إخفاء غير المحدد",
        graphmanipulationunhideall: "إظهار الكل",
        graphmanipulationgrabiphyungrabify: "Grabify / Ungrabify",
        graphmanipulationungrabifyselected: "Ungrabify المحدد",
        graphmanipulationungrabifynonselected: "Ungrabify غير المحدد",
        graphmanipulationgrabifyselected: "Grabify المحدد",
        graphmanipulationgrabifynonselected: "Grabify غير المحدد",
        graphmanipulationlockunlock: "قفل / فتح",
        graphmanipulationgrabifylockselected: "قفل المحدد",
        graphmanipulationgrabifylocknonselected: "قفل غير المحدد",
        graphmanipulationgrabifyunlockselected: "فتح المحدد",
        graphmanipulationgrabifyunlocknonselected: "فتح غير المحدد",
        graphmanipulationremoverestore: "إزالة / استعادة",
        graphmanipulationremoveselected: "إزالة المحدد",
        graphmanipulationremoveunselected: "إزالة غير المحدد",
        graphmanipulationremoveall: "إزالة الكل",
        graphmanipulationrestore: "استعادة",
        parameters: "الإعدادات",
        tooltips: "تلميحات",
        tooltipson: "تشغيل التلميحات",
        tooltipsoff: "إيقاف التلميحات",
        log: "السجل",
        showhidelog: "إظهار / إخفاء السجل",
        visualelementdisplaymode: "نمط عرض العناصر المرئية",
        visualelementdisplaymodenodes: "نمط عرض العُقَد",
        visualelementdisplaymodeboxes: "نمط عرض الصناديق",
        visualrelationdisplaymode: "نمط عرض العلاقات المرئية",
        visualrelationdisplaymodeedges: "نمط عرض الحواف",
        visualrelationdisplaymodenodes: "نمط عرض العُقَد",
        undoredo: "تراجع / إعادة",
        undoredoon: "تشغيل",
        undoredooff: "إيقاف",
        undoredoclear: "مسح",
        archimaterelationshipsrules: "قواعد علاقات ArchiMate",
        archimaterelationshiprulesenforce: "فرض",
        archimaterelationshiprulesrelax: "تخفيف",
        urlnavigation: "تنقل URL",
        urlnavigationchangemode: "تغيير النمط",
        checker: "المدقق",
        allowedrelationship: "العلاقات المسموحة في ArchiMate",
        palettes: "لوحات",
        archicg: "ArchiCG",
  ...
  zh: {
    translation: {
      menu: {
        ...
        fileexportowl: "OWL",
        filesaveasimage: "图像",
        filesaveasimageviewpng: "查看 PNG",
        filesaveasimagefullpng: "完整 PNG",
        filesaveasimageviewjpg: "查看 JPG",
        filesaveasimagefulljpg: "完整 JPG",
        filesaveasimageviewsvg: "查看 SVG",
        filesaveasimagefullsvg: "完整 SVG",
        compoundgraph: "复合图",
        compoundgraphnodes: "节点",
        compoundgraphcollapseallnodes: "折叠全部",
        compoundgraphcollapseselectedrecursively: "折叠选中项",
        compoundgraphcexpandallnodes: "展开全部",
        compoundgraphexpandselectedrecursively: "递归展开选中项",
        compoundgraphaddcompoundforselected: "为选中项添加复合",
        compoundgraphremoveselectedcompound: "删除选中复合",
        compoundgraphaddnestedforselected: "为选中项添加嵌套",
        compoundgraphcreatenodes: "创建节点",
        compoundgraphedges: "边",
        compoundgraphedgescollapsealledges: "折叠所有边",
        compoundgraphedgesexpandalledges: "展开所有边",
        compoundgraphedgescollapseselectededges: "折叠选中边",
        compoundgraphedgesexpandselectededges: "展开选中边",
        compoundgraphedgescollapsebetweenselected: "折叠选中之间",
        compoundgraphedgesexpandbetweenselected: "展开选中之间",
        compositegraph: "组件图",
        compositegraphselectedcompoundtograph: "将选中复合转换为图",
        compositegraphselectedgraphtocompound: "将选中图转换为复合",
        compositegraphcreatecomponent: "创建组件",
        compositegraphshowedges: "显示边",
        compositegraphhideedges: "隐藏边",
        graphmanipulation: "图形操作",
        graphmanipulationshowhide: "显示 / 隐藏",
        graphmanipulationhideselected: "隐藏选中项",
        graphmanipulationhidenonselected: "隐藏未选中项",
        graphmanipulationunhideall: "显示全部",
        graphmanipulationgrabiphyungrabify: "锁定 / 解锁",
        graphmanipulationungrabifyselected: "解锁选中项",
        graphmanipulationungrabifynonselected: "解锁未选中项",
        graphmanipulationgrabifyselected: "锁定选中项",
        graphmanipulationgrabifynonselected: "锁定未选中项",
        graphmanipulationlockunlock: "锁定 / 解锁",
        graphmanipulationgrabifylockselected: "锁定选中项",
        graphmanipulationgrabifylocknonselected: "锁定未选中项",
        graphmanipulationgrabifyunlockselected: "解锁选中项",
        graphmanipulationgrabifyunlocknonselected: "解锁未选中项",
        graphmanipulationremoverestore: "删除 / 恢复",
        graphmanipulationremoveselected: "删除选中项",
        graphmanipulationremoveunselected: "删除未选中项",
        graphmanipulationremoveall: "删除全部",
        graphmanipulationrestore: "恢复",
        parameters: "参数",
        tooltips: "工具提示",
        tooltipson: "开启提示",
        tooltipsoff: "关闭提示",
        log: "日志",
        showhidelog: "显示 / 隐藏日志",
        visualelementdisplaymode: "可视元素显示模式",
        visualelementdisplaymodenodes: "节点显示模式",
        visualelementdisplaymodeboxes: "盒子显示模式",
        visualrelationdisplaymode: "可视关系显示模式",
        visualrelationdisplaymodeedges: "边显示模式",
        visualrelationdisplaymodenodes: "节点显示模式",
        undoredo: "撤销 / 重做",
        undoredoon: "开启",
        undoredooff: "关闭",
        undoredoclear: "清除",
        archimaterelationshipsrules: "ArchiMate 关系规则",
        archimaterelationshiprulesenforce: "强制",
        archimaterelationshiprulesrelax: "放宽",
        urlnavigation: "URL 导航",
        urlnavigationchangemode: "切换模式",
        checker: "检查器",
        allowedrelationship: "允许的 ArchiMate 关系",
        palettes: "调色板",
        archicg: "ArchiCG",
  ...
  es: {
    translation: {
      menu: {
        ...
        fileexportcsv: "CSV",
        fileexportowl: "OWL",
        filesaveasimage: "Imagen",
        filesaveasimageviewpng: "Ver PNG",
        filesaveasimagefullpng: "PNG Completo",
        filesaveasimageviewjpg: "Ver JPG",
        filesaveasimagefulljpg: "JPG Completo",
        filesaveasimageviewsvg: "Ver SVG",
        filesaveasimagefullsvg: "SVG Completo",
        compoundgraph: "Grafo Compuesto",
        compoundgraphnodes: "Nodos",
        compoundgraphcollapseallnodes: "Colapsar Todos",
        compoundgraphcollapseselectedrecursively: "Colapsar Seleccionados",
        compoundgraphcexpandallnodes: "Expandir Todos",
        compoundgraphexpandselectedrecursively: "Expandir Seleccionados Recursivamente",
        compoundgraphaddcompoundforselected: "Agregar Compuesto a Seleccionados",
        compoundgraphremoveselectedcompound: "Eliminar Compuesto Seleccionado",
        compoundgraphaddnestedforselected: "Agregar Anidado a Seleccionados",
        compoundgraphcreatenodes: "Crear Nodos",
        compoundgraphedges: "Aristas",
        compoundgraphedgescollapsealledges: "Colapsar Todas las Aristas",
        compoundgraphedgesexpandalledges: "Expandir Todas las Aristas",
        compoundgraphedgescollapseselectededges: "Colapsar Aristas Seleccionadas",
        compoundgraphedgesexpandselectededges: "Expandir Aristas Seleccionadas",
        compoundgraphedgescollapsebetweenselected: "Colapsar Entre Seleccionados",
        compoundgraphedgesexpandbetweenselected: "Expandir Entre Seleccionados",
        compositegraph: "Grafo Compuesto",
        compositegraphselectedcompoundtograph: "Convertir Compuesto Seleccionado en Grafo",
        compositegraphselectedgraphtocompound: "Convertir Grafo Seleccionado en Compuesto",
        compositegraphcreatecomponent: "Crear Componente",
        compositegraphshowedges: "Mostrar Aristas",
        compositegraphhideedges: "Ocultar Aristas",
        graphmanipulation: "Manipulación del Grafo",
        graphmanipulationshowhide: "Mostrar / Ocultar",
        graphmanipulationhideselected: "Ocultar Seleccionados",
        graphmanipulationhidenonselected: "Ocultar No Seleccionados",
        graphmanipulationunhideall: "Mostrar Todo",
        graphmanipulationgrabiphyungrabify: "Fijar / Liberar",
        graphmanipulationungrabifyselected: "Liberar Seleccionados",
        graphmanipulationungrabifynonselected: "Liberar No Seleccionados",
        graphmanipulationgrabifyselected: "Fijar Seleccionados",
        graphmanipulationgrabifynonselected: "Fijar No Seleccionados",
        graphmanipulationlockunlock: "Bloquear / Desbloquear",
        graphmanipulationgrabifylockselected: "Bloquear Seleccionados",
        graphmanipulationgrabifylocknonselected: "Bloquear No Seleccionados",
        graphmanipulationgrabifyunlockselected: "Desbloquear Seleccionados",
        graphmanipulationgrabifyunlocknonselected: "Desbloquear No Seleccionados",
        graphmanipulationremoverestore: "Eliminar / Restaurar",
        graphmanipulationremoveselected: "Eliminar Seleccionados",
        graphmanipulationremoveunselected: "Eliminar No Seleccionados",
        graphmanipulationremoveall: "Eliminar Todo",
        graphmanipulationrestore: "Restaurar",
        parameters: "Parámetros",
        tooltips: "Información emergente",
        tooltipson: "Activar Información",
        tooltipsoff: "Desactivar Información",
        log: "Registro",
        showhidelog: "Mostrar / Ocultar Registro",
        visualelementdisplaymode: "Modo de Visualización de Elementos",
        visualelementdisplaymodenodes: "Modo Nodo",
        visualelementdisplaymodeboxes: "Modo Caja",
        visualrelationdisplaymode: "Modo de Visualización de Relaciones",
        visualrelationdisplaymodeedges: "Modo Arista",
        visualrelationdisplaymodenodes: "Modo Nodo",
        ...
        archimaterelationshiprulesenforce: "Aplicar",
        archimaterelationshiprulesrelax: "Relajar",
        urlnavigation: "Navegación por URL",
        urlnavigationchangemode: "Cambiar Modo",
        checker: "Validador",
        allowedrelationship: "Relación ArchiMate Permitida",
        palettes: "Paletas",
        archicg: "ArchiCG",
  ...
  it: {
    translation: {
      menu: {
        ...
        fileexportcsv: "CSV",
        fileexportowl: "OWL",
        filesaveasimage: "Immagine",
        filesaveasimageviewpng: "Visualizza PNG",
        filesaveasimagefullpng: "PNG Completo",
        filesaveasimageviewjpg: "Visualizza JPG",
        filesaveasimagefulljpg: "JPG Completo",
        filesaveasimageviewsvg: "Visualizza SVG",
        filesaveasimagefullsvg: "SVG Completo",
        compoundgraph: "Grafo Composto",
        compoundgraphnodes: "Nodi",
        compoundgraphcollapseallnodes: "Comprimi Tutti",
        compoundgraphcollapseselectedrecursively: "Comprimi Selezionati",
        compoundgraphcexpandallnodes: "Espandi Tutti",
        compoundgraphexpandselectedrecursively: "Espandi Selezionati Ricorsivamente",
        compoundgraphaddcompoundforselected: "Aggiungi Composto ai Selezionati",
        compoundgraphremoveselectedcompound: "Rimuovi Composto Selezionato",
        compoundgraphaddnestedforselected: "Aggiungi Nidificato ai Selezionati",
        compoundgraphcreatenodes: "Crea Nodi",
        compoundgraphedges: "Archi",
        compoundgraphedgescollapsealledges: "Comprimi Tutti gli Archi",
        compoundgraphedgesexpandalledges: "Espandi Tutti gli Archi",
        compoundgraphedgescollapseselectededges: "Comprimi Archi Selezionati",
        compoundgraphedgesexpandselectededges: "Espandi Archi Selezionati",
        compoundgraphedgescollapsebetweenselected: "Comprimi Tra Selezionati",
        compoundgraphedgesexpandbetweenselected: "Espandi Tra Selezionati",
        compositegraph: "Grafo Composito",
        compositegraphselectedcompoundtograph: "Composto Selezionato in Grafo",
        compositegraphselectedgraphtocompound: "Grafo Selezionato in Composto",
        compositegraphcreatecomponent: "Crea Componente",
        compositegraphshowedges: "Mostra Archi",
        compositegraphhideedges: "Nascondi Archi",
        graphmanipulation: "Manipolazione del Grafo",
        graphmanipulationshowhide: "Mostra / Nascondi",
        graphmanipulationhideselected: "Nascondi Selezionati",
        graphmanipulationhidenonselected: "Nascondi Non Selezionati",
        graphmanipulationunhideall: "Mostra Tutto",
        graphmanipulationgrabiphyungrabify: "Fissa / Libera",
        graphmanipulationungrabifyselected: "Libera Selezionati",
        graphmanipulationungrabifynonselected: "Libera Non Selezionati",
        graphmanipulationgrabifyselected: "Fissa Selezionati",
        graphmanipulationgrabifynonselected: "Fissa Non Selezionati",
        graphmanipulationlockunlock: "Blocca / Sblocca",
        graphmanipulationgrabifylockselected: "Blocca Selezionati",
        graphmanipulationgrabifylocknonselected: "Blocca Non Selezionati",
        graphmanipulationgrabifyunlockselected: "Sblocca Selezionati",
        graphmanipulationgrabifyunlocknonselected: "Sblocca Non Selezionati",
        graphmanipulationremoverestore: "Rimuovi / Ripristina",
        graphmanipulationremoveselected: "Rimuovi Selezionati",
        graphmanipulationremoveunselected: "Rimuovi Non Selezionati",
        graphmanipulationremoveall: "Rimuovi Tutto",
        graphmanipulationrestore: "Ripristina",
        parameters: "Parametri",
        tooltips: "Suggerimenti",
        tooltipson: "Suggerimenti Attivi",
        tooltipsoff: "Suggerimenti Disattivi",
        log: "Registro",
        showhidelog: "Mostra / Nascondi Registro",
        visualelementdisplaymode: "Modalità Visualizzazione Elementi",
        visualelementdisplaymodenodes: "Modalità Nodo",
        visualelementdisplaymodeboxes: "Modalità Box",
        visualrelationdisplaymode: "Modalità Visualizzazione Relazioni",
        visualrelationdisplaymodeedges: "Modalità Arco",
        visualrelationdisplaymodenodes: "Modalità Nodo",
        undoredo: "Annulla / Ripeti",
        undoredoon: "Attivo",
        undoredooff: "Disattivo",
        undoredoclear: "Pulisci",
        archimaterelationshipsrules: "Regole Relazioni ArchiMate",
        archimaterelationshiprulesenforce: "Applica",
        archimaterelationshiprulesrelax: "Allenta",
        urlnavigation: "Navigazione URL",
        urlnavigationchangemode: "Cambia Modalità",
        checker: "Validatore",
        allowedrelationship: "Relazione ArchiMate Permessa",
        palettes: "Tavolozze",
        archicg: "ArchiCG",
...
// call for including en and fr resources <- to import the related scripts in html with function completing resources 
...
function getMenuItems() {
  return [
    {
      type: 'menu', id: 'file', text: i18next.t("menu.file"), icon: "fa fa-file",
      items: [
        { id: 'fileload', text: i18next.t("menu.fileload"), tooltip: i18next.t("tooltip.fileload"), icon: "fa fa-file-import" },//"Loading previously saved archicg graph." },//id1
        { id: 'filesave', text: i18next.t("menu.filesave"), tooltip: i18next.t("tooltip.filesave"), icon: "fa fa-save" },//"Loading previously saved archicg graph." },//id1

        //{ id: 'id2', text: 'Save' },
        { text: '--' },
        {
          id: 'fileimport', text: i18next.t("menu.filesimport"), tooltip: i18next.t("tooltip.fileimport"), icon: "fa fa-file-upload",//id: 'id3', text: 'Import',
          items: [
            { id: 'fileimportjarchicg', text: i18next.t("menu.fileimportjarchicg"), tooltip: i18next.t("tooltip.fileimportjarchicg"), icon: "fa fa-file-code" },//{ id: 'id4', text: 'jArchiECG' },
            { id: 'fileimportoef', text: i18next.t("menu.fileimportoef"), tooltip: i18next.t("tooltip.fileimportoef"), icon: "fa fa-file-lines" },//{ id: 'oef', text: 'Open Format' },
            { id: 'fileimportjson', text: i18next.t("menu.fileimportjson"), tooltip: i18next.t("tooltip.fileimportjson"), icon: "fa fa-file-code" },//{ id: 'json', text: 'cytoscape Json' }
          ]
        },
        { text: '--' },

        {
          id: 'fileexport', text: i18next.t("menu.fileexport"), tooltip: i18next.t("tooltip.fileexport"), icon: "fa fa-file-export",//id: 'id7', text: 'Export',
          items: [
            { id: 'fileexportcsv', text: i18next.t("menu.fileexportcsv"), tooltip: i18next.t("tooltip.fileexportcsv"), icon: "fa fa-file-csv" },//{ id: 'id8', text: 'CSV' },
            { id: 'fileexportowl', text: i18next.t("menu.fileexportowl"), tooltip: i18next.t("tooltip.fileexportowl"), icon: "fa fa-brain" },//{ id: 'owlexport', text: 'OWL' },
          ]
        },
        { text: '--' },
        {
          id: 'filesaveasimage', text: i18next.t("menu.filesaveasimage"), tooltip: i18next.t("tooltip.filesaveasimage"), icon: "fa fa-image",//id: 'id9', text: 'Save as image',
          items: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de", text: i18next.t("de") },
        { id: "es", text: i18next.t("es") },
        { id: "it", text: i18next.t("it") },
        { id: "ar", text: i18next.t("ar") },
        { id: "zh", text: i18next.t("zh") },
      ]
    }
  ]
}
...
function handleMenuAction(event) {
  ...
  switch (event.target) {
    case 'file:fileload':
      ...
      el = document.getElementById('load-from-inp');
      el.value = '';
      el.click();
      break;
    ...
    case 'file:fileimportjarchicg':
      el = document.getElementById('load-from-jarchi');
      el.value = '';
      el.click();
      break;

    case 'file:fileimportoef':
      el = document.getElementById('load-from-open-format');
      el.value = ''; el.click();
      break;

    case 'file:fileimportjson':
      el = document.getElementById('load-from-cytoscape-json');
      el.value = ''; el.click();
      break;

    case 'file:fileexportcsv':
    ...
    case 'file:fileexportowl':
      ...
      w2prompt({
        ...
        .ok(function () {
          ...
          var modelName = fileNameToSave.replace(/\.[^/.]+$/, "");
          ...
          saveTxtFile(JSON.stringify(owlImport.concat(myNodes).concat(myEdges)), fileNameToSave, 'text/plain');
        });
      break;

    case 'file:filesaveasimageviewpng':
    ...
    case 'file:filesaveasimagefullpng':
    ...
    case 'file:filesaveasimageviewjpg':
    ...
    case 'file:filesaveasimagefulljpg':
    ...
    case 'file:filesaveasimageviewsvg':
    ...
    case 'file:filesaveasimagefullsvg':
    ...
    case 'compoundgraph:compoundgraphremoveselectedcompound':
    ...
    case 'compoundgraph:compoundgraphaddnestedforselected':
    ...
    case 'compoundgraph:compoundgraphcreatenodes':
      break;

    case 'compoundgraph:compoundgraphedgescollapsealledges':
      if (undoRedo) { ur.do("collapseAllEdges", { options: getEdgeOptions() }) } else { api.collapseAllEdges(getEdgeOptions()); }
      break;

    case 'compoundgraph:compoundgraphedgesexpandalledges':
    ...
    case 'compoundgraph:compoundgraphedgescollapseselectededges':
    ...
    case 'compoundgraph:compoundgraphedgesexpandselectededges':
    ...
    case 'compoundgraph:compoundgraphedgescollapsebetweenselected':

      break;

    case 'compoundgraph:compoundgraphedgesexpandbetweenselected':
    ...
    case 'compositegraph:compositegraphselectedcompoundtograph':
    ...
    case 'compositegraph:compositegraphselectedgraphtocompound':
      break;

    case 'compositegraph:compositegraphcreatecomponent':
      break;

    case 'compositegraph:compositegraphshowedges':
      break;

    case 'compositegraph:compositegraphhideedges':
      break;

    case 'graphmanipulation:graphmanipulationshowhide':
    ...
    case 'language:zh':
      changeLanguage('zh')
      break;
    case 'checker:allowedrelationship':
      cy.edges().forEach(function (edge) {
        if (allowedArchiMateRelation(edge) === undefined) { console.log("undefined") } else {
          //   console.log(allowedArchiMateRelation(edge) );
          edge.data("ArchiMateAllowedRelationship", allowedArchiMateRelation(edge))
        }
      })
...
function readTxtFile(file, cb) {
  ...
  fileReader.onload = () => {
    try {
      ...
      console.log('Given file is not suitable. ' + error);
    }
  };
...
function relationsEdgesToNodes() {
  ...
  eles.forEach(function (edge) {
    ...
    try {
      ...
      console.log('relationEdgesToNodes error: ' + error);
    }
  })
}
...
var config = {
    ...
    toolbar: {
      ...
      onClick: function (event) {
        ...
        if (event.target == 'update') {
          //get the id  "id" of the active graph element selected by mean of dblclick
          var myGraphObject = cy.$id(w2ui.form2.getValue("identifier"));
          console.log("identifier: " + w2ui.form2.getValue("identifier"))
          //iterate on the records of the grid, each giving name and value
          // and for each of them, set the cy$(id).data(name) to value
          // If new value, it will update the node property
          // If new property, it will add the node property
          ...
          //cy.$id(w2ui.form.getValue("identifier")).data("label")
          console.log("Data: " + myGraphObject.data("label"));
          console.log("Data: " + myGraphObject.data("attributes"));
  ...
  mainmenu: {
    ...
    onClick: function (event) {
      ...
      console.log('Click:', label2);

      gtag('event', 'click', {
        'event_category': 'mainmenu',
        'event_label': label2
      });
      ...
      if (event.target == "parameters:id1") {
        ...
        console.log("tooltipOn" + myPalette2())
      ...
      if (event.target == "parameters:id2") {
        ...
        savePaletteButtonsCheck();
        console.log("tooltipOff" + myPalette2())
        w2ui['mainLayout'].html('right', myPalette2());
        restorePaletteButtonsCheck();
        var paletteElement = document.getElementsByClassName("el-button");
        for (var i = 0; i < paletteElement.length; i++) {
...
function main() {
  ...
  var pstyle = 'border: 1px solid #efefef; padding: 0px;background-color:white; font-size: 15px';
  $('#archicg-layout').w2layout({
    ...
    panels: [
      ...
      { type: 'left', size: "22%", resizable: true, style: pstyle, html: 'left' },
      {
        ...
        ` },
      { type: 'top', size: "30px", resizable: true, style: pstyle, html: "top" },
  ...
  /*
  w2ui['mainmenu'].insert('parameters', {
    type: 'menu', id: 'mainmenu', text: 'Tools',
    items: toolsMenuItems
  });
  */

  //w2ui['mainmenu'].on({ type: 'click' }, function (target, eventData) {   if (tools.includes(target.split(':')[1])) { activateToolBar(target.split(':')[1]); }
  ...
  cy.on('drag', function (event) {
    ...
    console.log(`Target: ${event.target ? event.target.id() : 'No target'}`);
    console.log(event);
  });
  ...
  function headerFromSelected() {
    ...
    if (selected.length == 1) {
      selected.forEach(function (el) {
        ...
        if (el.isEdge()) {
          if (el.data("edgeType") !== null && el.data("edgeType") !== undefined) {
...
Access it using the  Tools menu.`)
    ...
    try {
      if (fileIndex > -1) {
        readTxtFile(this.files[0], function (txt) {
          ...
          console.log(`Entity Name: ${myEntityName}`)
          var myParseResult = Papa.parse(txt, {
            header: true, step: function (row) {
              console(row.data)
              //parseRow(row.data, myEntityName);
            }, complete: function (results) { console.log(myFile.name + " parsed") }
          });
        });
      }
      ...
      if (model.querySelectorAll("parsererror").length > 0) {
        ...
        const modelRelationships = [].map.call(model.querySelectorAll("relationship"), (r) => {
          ...
          if (!isSourceValid || !isTargetValid) {
            console.log(`Skipping relationship '${edgeAttributs.id}' because it references an edge or invalid node.`);
  ...
  function itemToGraph(parent, item) {
    ...
    if (identifierRef !== null && identifierRef !== "" && parent !== null && parent !== "") {
      console.log("referenced item:" + item.getAttribute("identifierRef"));
      ...
      console.log(myNode[0].group);
      console.log(JSON.stringify(myNode[0].data))
      ...
      for (let i = 0; i < myChildItems.length; i++) {
        console.log(myChildItems[i].tagName);
  ...
  function includeFolders(model, modelId) {
    try {
      ...
      if (organizations.length > 1) {
        console.log("Invalid OEF structure: " + organizations.length + " organizations elements <br/>");
      } else if (organizations.length === 0) {
        console.log("No organizations found in the model.");
      } else {
        console.log("Valid OEF structure");
      ...
      console.log("An error occurred in includeFolders: " + error.message);
      console.error(error);
    }
  }
...
function renderEdge(ele) {
  ...
  if (typeof ele.data(globalColoredProperty) !== 'undefined') {
    ...
    } catch (error) { console.log("erreur 4") }
    try {
      if (valueTypeColorDefined) { var lineColor = pColor(typeof ele.data(globalColorProperty)); }
    } catch (error) { console.log("erreur 4") }
  }

    var opfLevel=ele.data("opflevel")
    if (ele.data('opflevel') === "1"){lineColor="orange";}
    if (ele.data('opflevel') === "2"){lineColor="green";}
...
function renderParentNode(ele) {
  ...
  if (typeof ele.data(globalColoredProperty) !== 'undefined') {
    ...
    } catch (error) { console.log("erreur 1") }
    try {
      if (valueTypeColorDefined) {
        dcolor = pColor(typeof ele.data(globalColoredProperty));
        overlayOpacity = POverlayOpacity;
      }
    } catch (error) { console.log("erreur 2") }
  }
...
function importAlfabetEntities(txt) {
  ...
  try { cy.add(myEntityNodes) } catch (e) { console.log("[importAlfabetEntities]" + e); }
}
...
function importAlfabetAttributes(txt) {
  ...
  keys.forEach((entity, index) => {
    try { cy.$id(entity).data("attributes", JSON.stringify(myAggregation[entity]["Attributes"])) } catch (e) { console.log(`[importAlfabetAttributes]${entity}[data[attributes]]` + e) }
...
function importAlfabetRelations(txt) {
  ...
  myRelationEdges.forEach((relation, index) => {
    try { cy.add(relation) } catch (e) { console.log("[importAlfabetRelations]" + index + "=>" + e) }
  })
}
...
function attributesParent(attribute) {
  ...
  if (cy.$id(myEntity)) { }
    ...
    console.log("[attributesParent][!entity]" + myEntity)
    myEntity = "alfabet-relation-type-" + String(attribute["RELATIONS.PROPERTY"]).trim().replace(/ +/g, "_");
    if (cy.$id(myEntity)) { }
    else {
      console.log("[attributesParent][!relation]" + myEntity);
      myEntity = "alfabet-information-model"; console.log("alfabet-information-model");
    }
  }
  return myEntity;
...
function gridEntityAttribute(theJSONAttributes) {
  ...
  try {
    ...
    keys.forEach((attribute, index) => {
      ...
      catch (e) { console.log(`[gridEntityAttribute]` + e) }

    })

    w2ui['gridAttributes'].add(myAttributeGrid);
  } catch (error) {
    console.log("[gridEntityAttribute]" + error)
